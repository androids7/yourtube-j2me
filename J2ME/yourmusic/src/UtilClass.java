...
public class UtilClass extends Object {
    ...
    public static String MakeFullFileURL(String file_name) {
        ...
        try {
            file = (FileConnection)Connector.open("file:///" + SettingStorageClass.GetDestinationDisk() + "DATA/Sounds");

            if (file.exists()) {
                return "file:///" + SettingStorageClass.GetDestinationDisk() + "DATA/Sounds/" + file_name;
            }
        } catch (Exception ex) {
            // Ignore
        } finally {
        ...
        try {
            file = (FileConnection)Connector.open("file:///" + SettingStorageClass.GetDestinationDisk() + "Sounds");

            if (file.exists()) {
                return "file:///" + SettingStorageClass.GetDestinationDisk() + "Sounds/" + file_name;
            }
        } catch (Exception ex) {
            // Ignore
        } finally {
    ...
    public static String GetDefaultMusicDisk() {
